...
def report(
    ...
    top_k_categories: int = typer.Option(5, help="Сколько самых частых значений показывать для колонки."),
    title: str = typer.Option("EDA-отчёт", help="Заголовок отчёта в Markdown (первая строка файла).",),
) -> None:
    """
    ...
    """
    out_root = Path(out_dir) / Path(path).stem
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Есть дубликаты в user_id: **{quality_flags['has_suspicious_user_id_duplicates']}**\n\n")
